        ...
        <div class="page page-contact">
            <div class="header">
                ...
                <%                    try {
                        ...
                        String QueryString = "SELECT criminal_id,name,nid,age,height,current_status,crime_engagement FROM criminal ORDER BY marking DESC";
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <%                    while (rs.next()) {
                            int id = rs.getInt(1);
                        String status = "";
                        if (rs.getString(6).contains("1")) {
                            status = "Hide Away";
                        } else if (rs.getString(7).contains("2")) {
                            status = "In Jail";
                        } else {
                            status = "In Bail";
                        }
