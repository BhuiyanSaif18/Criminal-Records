    ...
    <body>
        ...
        <%
            ...
            if (tempSession.getAttribute("loggedInOrNot") != "1") {
                ...
                if (tempSession.getAttribute("accountType") == "3") {

                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('This Option is reserved for Analyzers and Admin');");
            ...
            <div class="header">
                <div>
                    ...
                    <ul>
                        ...
                        <li >
                            <a href="allCriminals.jsp">All Criminals</a> <span>Criminal Based list</span> 
                        </li>
                        <li class="selected">
                ...
                <%                    try {
                        ...
                        System.out.println("All criminal: line 1");
                        Class.forName("com.mysql.jdbc.Driver").newInstance();

                        System.out.println("All criminal: line 2");
                        connection = DriverManager.getConnection(connectionURL, "root", "123456");
                        System.out.println("All criminal: line 3");
                        statement = connection.createStatement();

                        String QueryString = "SELECT crime_id,Heading,type,dead,injured,victim_data,criminals_number FROM crime ORDER BY crime_id DESC";

                        rs = statement.executeQuery(QueryString);
                        System.out.println("hello chacking 1");
                        int type = 1;
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        String crime_type = "";
                        if (rs.getString(3).contains("1")) {
                            crime_type = "Antisocial Behavior";
                        } else if (rs.getString(3).contains("2")) {
                           crime_type = "Arson";
                        } else if (rs.getString(3).contains("3")) {
                           crime_type = "Burglary";
                        } else if (rs.getString(3).contains("4")) {
                           crime_type = "Childhood Abuse";
                        } else if (rs.getString(3).contains("5")) {
                           crime_type = "Crime Abroad";
                        } else if (rs.getString(3).contains("6")) {
                           crime_type = "Domestic Abuse";
                        } else if (rs.getString(3).contains("7")) {
                           crime_type = "Fraud";
                        } else if (rs.getString(3).contains("8")) {
                           crime_type = "Hate Crime";
                        } else if (rs.getString(3).contains("9")) {
                           crime_type = "Murder or Manslaughter";
                        } else if (rs.getString(3).contains("10")) {
                           crime_type = "Organized Crime";
                        } else if (rs.getString(3).contains("11")) {
                           crime_type = "Property Crime";
                        } else if (rs.getString(3).contains("12")) {
                           crime_type = "Rape, Sexual Assault & Sexual Harassment";
                        } else if (rs.getString(3).contains("13")) {
                           crime_type = "Robbery";
                        } else if (rs.getString(3).contains("14")) {
                           crime_type = "Stalking, Offenses & Harassment";
                        } else if (rs.getString(3).contains("15")) {
                           crime_type = "Terror Attack";
                        } else if (rs.getString(3).contains("16")) {
                           crime_type = "Violent Crime";
                        } else if (rs.getString(3).contains("17")) {
                           crime_type = "Others";
                        }
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString(6)%> Inches</td>
                            <td><%=rs.getString(7)%></td>
                            

                            <td><form action="ViewingDetails" method="get">
                                    <input type="hidden" name="criminal_id" value = "<%=id%>">
                    <input type="hidden" name="type" value = "<%=type%>">
                                    <input type="submit" class="btn btn-danger" value="View Details">
                                </form>
                            </td>
