...
LOCK TABLES `join_table` WRITE;
/*!40000 ALTER TABLE `join_table` DISABLE KEYS */;
INSERT INTO `join_table` VALUES (1,1,1),(2,1,2);
/*!40000 ALTER TABLE `join_table` ENABLE KEYS */;
UNLOCK TABLES;
