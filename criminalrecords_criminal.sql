...
CREATE TABLE `criminal` (
  ...
  `profile_searched` int(11) DEFAULT NULL,
  `crime_engagement` int(11) DEFAULT NULL,
...
INSERT INTO `criminal` VALUES (1,'Rakibul Hasan Rafi','1234567890123',29,66,1,20,3,10),(2,'Ragib Ishraq','9876543213210',28,69,1,15,1,5);
